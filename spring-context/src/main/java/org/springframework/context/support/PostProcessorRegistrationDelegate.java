...
class PostProcessorRegistrationDelegate {
	 ...
	 *
	 * 	5.1. 调用ApplicationContext的beanFactoryPostProcessors中类型为BeanDefinitionRegistryPostProcessor的postProcessBeanFactory
	 * 	5.2. 调用BeanFactory的beanDifinition中类型为BeanDefinitionRegistryPostProcessor的postProcessBeanFactory
	 * 	6. 调用ApplicationContext的beanFactoryPostProcessors中类型不为BeanDefinitionRegistryPostProcessor的postProcessBeanFactory
	 *
