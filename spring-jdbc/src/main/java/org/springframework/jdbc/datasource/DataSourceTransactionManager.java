...
public class DataSourceTransactionManager extends AbstractPlatformTransactionManager
    ...
    /**
     * DataSourceTransactionManager 支持嵌套事务
     * <p>
    ...
    /**
     * 第一次获取事务的化: DataSourceTransactionObject的ConnectionHolder是null
     * 第二次获取事务的话：DataSourceTransactionObject的ConnectionHolder是第一次后面注册进去的连接
     * @return
     */
    @Override
    ...
    protected void doBegin(Object transaction, TransactionDefinition definition) {
        ...
        try {
            ...
            //根据transaction定义来预处理连接(只读标识和隔离级别)
